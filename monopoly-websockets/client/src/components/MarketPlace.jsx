...
const MarketPlace = () => {
  ...
  return (
    <section className="dashboard__market-place--container">
      <h1 className="dashboard__market-place__title">O mercado livre:</h1>
      <section className="dashboard__market-place">
        <section className="dashboard__market-place__block">
          <h3 className="dashboard__market-place__subtitle">Vendedor</h3>
          {state.loaded
        ...
        <section className="dashboard__market-place__block">
          <h3 className="dashboard__market-place__subtitle">Propriedade</h3>
          {state.loaded
            ? Object.keys(state.boardState.openMarket).map(item => (
        ...
        <section className="dashboard__market-place__block">
          <h3 className="dashboard__market-place__subtitle">Preço</h3>
          {state.loaded
            ? Object.keys(state.boardState.openMarket).map(item => (
              <p>
                $
